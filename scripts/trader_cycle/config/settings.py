...
VOL_REGIME_CONFIRMATION = 1  # direct assignment (hysteresis removed)

# ─── Regime SL/TP Adjustment ───
REGIME_ADJUST_ENABLED = True
REGIME_ATR_EXPAND_THRESHOLD = 1.3
REGIME_ATR_CONTRACT_THRESHOLD = 0.7
...
try:
    ...
    # Regime SL/TP adjustment params from params.py
    REGIME_ADJUST_ENABLED = getattr(_mod, "REGIME_ADJUST_ENABLED", REGIME_ADJUST_ENABLED)
    REGIME_ATR_EXPAND_THRESHOLD = getattr(_mod, "REGIME_ATR_EXPAND_THRESHOLD", REGIME_ATR_EXPAND_THRESHOLD)
    REGIME_ATR_CONTRACT_THRESHOLD = getattr(_mod, "REGIME_ATR_CONTRACT_THRESHOLD", REGIME_ATR_CONTRACT_THRESHOLD)
