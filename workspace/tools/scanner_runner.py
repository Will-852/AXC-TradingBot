...
LIGHT_SCAN = os.path.join(TOOLS_DIR, "light_scan.py")
TRADER_CYCLE = os.path.join(TOOLS_DIR, "trader_cycle", "main.py")
SIGNAL_MD = os.path.join(os.path.dirname(WORKSPACE), "shared", "SIGNAL.md")
LOCK_FILE = os.path.join(os.path.dirname(WORKSPACE), "shared", "scanner_runner.lock")
